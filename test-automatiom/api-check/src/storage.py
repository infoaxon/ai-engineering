...
class Storage:
    ...
    async def get_latest_status(self, customer_id: str, environment: str, api_name: str) -> HealthCheckResult | None:
        ...
        async with aiosqlite.connect(self.db_path) as db:
            ...
            async with db.execute("""
                ...
                LIMIT 1
            """, (customer_id, environment, api_name)) as cursor:
    ...
    async def get_api_status(self, customer_id: str, environment: str, api_name: str) -> APIStatus:
        ...
        async with aiosqlite.connect(self.db_path) as db:
            ...
            """, (customer_id, environment, api_name, cutoff.isoformat())) as cursor:
    ...
    async def get_environment_statuses(self, customer_id: str, environment: str, api_names: list[str]) -> list[APIStatus]:
    ...
    async def get_history(
        ...
        async with aiosqlite.connect(self.db_path) as db:
            ...
            async with db.execute("""
                ...
                ORDER BY timestamp DESC
                LIMIT ?
            """, (customer_id, environment, api_name, cutoff.isoformat(), limit)) as cursor:
